function buildMetadata(sample) {
    d3.json("https://github.com/JordanCB0814/Project-03-JMPC/blob/main/Overdose_NVSS/Overdose_Deaths_US.Overdose_Deaths.jsonhttps://bc-edx.com/data/dl-1-2/m14/lms/starter/samples.json").then((data) => {
...
function buildCharts(sample) {
    d3.json("https://github.com/JordanCB0814/Project-03-JMPC/blob/main/Overdose_NVSS/Overdose_Deaths_US.Overdose_Deaths.json").then((data) => {
